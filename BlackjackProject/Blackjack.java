      ...
      while (answer.equals("y")) { 
         ...
         //See if dealer has more points than player
            if ((player2Cards.cardsValue() <= 21) && (player1Cards.cardsValue() <= 21)) {
               ...
               if ((player2Cards.cardsValue() == player1Cards.cardsValue())&&endRound == false) {
               ...
               else if((player2Cards.cardsValue() > player1Cards.cardsValue())&&endRound == false){
               ...
               else if ((player1Cards.cardsValue() > player2Cards.cardsValue())&&endRound == false) {
                  System.out.println(name1 + " wins!");
                  player1Money += player2Bet;
